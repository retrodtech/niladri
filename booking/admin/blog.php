...
if(isset($_GET['update'])){
    ...
    if(isset($_POST['submit'])){
        ...
        if(in_array($ext,$extension)){
            $newfilename=rand(100000,999999).".".$ext;
            move_uploaded_file($galleryImgTemp, SERVER_ADMIN_IMG.'post/'.$newfilename);
            $slug = slugGenerate($text);
            mysqli_query($conDB, "insert into blog(title,slug,img,description,category) values('$text','$slug','$newfilename','$desc','$category')");
                                ...
                                <div class="table-responsive">
                                    <table class="table align-items-center mb-0">
                                        <tr>
                                            ...
                                            <th width="20%" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Title</th>
                                            <th width="10%" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Category</th>
                                            <th width="50%" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Description</th>
                                            <th width="10%" width="250px" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"></th>
                                        </tr>
                                        <tr>
                                            <?php
                                                ...
                                                while($imgrow = mysqli_fetch_assoc($sql)){
                                                    ...
                                                    echo '
                                                        <tr>
                                                            ...
                                                            <th class="mb-0 text-xs"><small>'.$imgrow['description'].'</small></th>
