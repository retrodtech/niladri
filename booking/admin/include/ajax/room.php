...
if(isset($_POST['type'])){
    ...
    if($type == 'persionCheckout'){
        ...
        $sql = "insert into booking(bookinId,name,email,phone,company_name,comGst,payment_status,add_on,partial,couponCode,pickUp,grossCharge,userPay) values('$bid','$personName','$personEmail','$personPhoneNo','$companyName','$companyGst','pending','$add_on','$partial','$couponCode','$pickUp','$grossAmount','$userPay')";
